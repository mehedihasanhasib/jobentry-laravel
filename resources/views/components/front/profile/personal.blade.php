    ...
    <div class="card shadow-sm rounded border-0">
        ...
        <div class="card-body">
            ...
            <form class="row mb-4" id="editView" style="display: none" action="{{ route('user.profile.personal.update') }}" method="POST">
                ...
                <x-save_close_buttons saveButtonClick="save(event, $(this), '{{ route('user.profile.personal') }}')" closeButtonClick="editInput('textView', 'editView', 'editButton', 0, event)" :delete="true" />
            </form>
        </div>
    </div>
@else
